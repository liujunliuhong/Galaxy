...
public class GLAlertEngine {
    public class Options {
        public var fromPosition: GLAlertEngine.FromPosition = .rightCenter(left: .zero)
        public var toPosition: GLAlertEngine.ToPostion = .center
        public var dismissPosition: GLAlertEngine.FromPosition = .none
        //
    ...
    public static let `default` = GLAlertEngine()
...
extension GLAlertEngine {
    public func show(parentView: UIView?, alertView: UIView?, options: GLAlertEngine.Options) {
        //
...
private func setFromPositionConstraints(view: UIView?, fromPosition: GLAlertEngine.FromPosition) {
...
private func setToPositionConstraints(view: UIView?, toPosition: GLAlertEngine.ToPostion) {
    guard let view = view else { return }
...
private func setDismissPositionConstraints(view: UIView?, dismissPosition: GLAlertEngine.FromPosition) {
    guard let view = view else { return }
    guard let superview = view.superview else { return }
