//
//  GLDatingApplyForRefundViewController.swift
//  SwiftTool
//
...
public class GLDatingApplyForRefundViewController: UIViewController {

    private lazy var viewModel: GLDatingApplyForRefundViewModel = {
        let viewModel = GLDatingApplyForRefundViewModel()
        return viewModel
    }()
    
    private lazy var successView: GLDatingRefundSuccessView = {
        let successView = GLDatingRefundSuccessView()
        successView.title = "Thank you very much. Our staff will contact you by email within 7 working days. Please check in time."
        successView.isHidden = true
        return successView
    }()
    
    private lazy var contentView: GLDatingApplyForRefundContentView = {
        let contentView = GLDatingApplyForRefundContentView(viewModel: self.viewModel)
